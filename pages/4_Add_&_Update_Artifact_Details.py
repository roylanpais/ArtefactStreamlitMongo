...
st.set_page_config(page_title="Add New Artifact or Update Artifact Details", page_icon="🏺")

# Check Authentication
check_authentication()

st.title("Add New Artifact or Update Artifact Details")
...
if not church_names:
    ...
    st.page_link("pages/5_Add_&_Update_Church_Details.py", label="Go to Add Church Page", icon="⛪")
else:
    with st.form("add_artifact_form"):
        artifact_name = st.text_input("Artifact Name")
        ...
        submitted = st.form_submit_button("Add Artifact")
